 ...
 * 	문자열 (참조변수)
 * 		String (문자 여러개 저장이 가능) => 4GB 까지 저장가능 => StringBuffer
 * 
 * 	= 초기화
 * 		byte => 0
 * 		int => 0(10진법)
 ...
 *						= 강제형변환 (필요시에만 사용, 권장사항은 x)
 *						int a=10.5(X)
 *						int a=(int)10.5; => int 10 (소수점 이하는 제외)
 *
 *			83page 크기
...
public class 자바변수정리 {
	...
	public static void main(String[] args) {
		...
		// 70~80% String => 웹은 int (X) => 메모리에 저장 => 브라우저로 전송
		// 서버 컴퓨터
		// 상세 보기
